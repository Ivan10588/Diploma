...
from .views import (
    ...
    contact_seller, add_review, toggle_favorite, add_to_comparison, comparison_view, 
...
urlpatterns = [
    ...
    path('chat/', chat_view, name='chat_general'),
    path('chat/<int:equipment_id>/', chat_view, name='chat_for_equipment'),
